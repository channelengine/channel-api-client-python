...
class ChannelShipmentResponse(object):
    ...
    def __init__(self, channel_order_no=None, lines=None, created_at=None, updated_at=None, track_trace_no=None, track_trace_url=None, return_track_trace_no=None, method=None, local_vars_configuration=None):  # noqa: E501
