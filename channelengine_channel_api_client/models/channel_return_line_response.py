...
class ChannelReturnLineResponse(object):
    ...
    def __init__(self, channel_product_no=None, merchant_product_no=None, accepted_quantity=None, rejected_quantity=None, quantity=None, local_vars_configuration=None):  # noqa: E501
